                        ...
                        <ul class="nav nav-tabs pull-left in">
                            <li class="active">
                                <a><i class="fa fa-clock-o"></i>
                                    <span class="hidden-mobile hidden-tablet">项目编辑</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="no-padding" role="content">
                        <div class="widget-body">
                            <form class="smart-form" method="post">
                                <fieldset>
                                    <section>
                                        <label class="label">项目名（必填）</label>
                                        <label class="input">
                                            <?=$form['name']?>
                                        </label>
                                    </section>
                                    <section>
                                        <label class="label">项目标识符（必填，唯一，26个小写字母组合）</label>
                                        <label class="input">
                                            <?=$form['identifier']?>
                                        </label>
                                    </section>
                                    <section>
                                        <label class="label">项目描述（选填）</label>
                                        <label class="input">
                                            <?=$form['description']?>
                                        </label>
                                    </section>
